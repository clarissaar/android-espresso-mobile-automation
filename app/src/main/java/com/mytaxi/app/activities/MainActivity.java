...
import com.mytaxi.app.adapters.DriverAdapter;
import com.mytaxi.app.dependencies.component.AppComponent;
import com.mytaxi.app.models.Driver;
...
public class MainActivity extends AuthenticatedActivity
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        ...
                        if (task.isSuccessful() && ((mLastKnownLocation = (Location) task.getResult()) != null)) {
                            ...
                            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(lastKnownLatLng, Constants.DEFAULT_ZOOM));
                        } else {
                            mMap.addMarker(new MarkerOptions().position(Constants.DEFAULT_LOCATION).draggable(true).icon(mIconMarker));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_logout) {
            ...
            Log.i(Constants.LOG_TAG, "User is logged out");
            startActivity(AuthenticationActivity.createIntent(MainActivity.this));
        }
