package com.mytaxi.app.utils.network;
...
public class HttpClient {
    ...
    public HttpClient() {
        mClient = new OkHttpClient.Builder().readTimeout(Constants.SOCKET_TIMEOUT, TimeUnit.SECONDS).build();
        ...
        mClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    Log.i(Constants.LOG_TAG, "Fetched successfully " + drivers.size() + " drivers.");
